...
/* if LTC has AES engine but doesn't have GCM, use software with LTC AES ECB mode */
...
#ifdef NXP_SDK
#if (defined(CPU_MPC5748G) || defined(CPU_S32K148) || defined(CPU_MPC5777C) || defined(CPU_S32R274) || defined(CPU_S32V234) || \
     defined(CPU_S32R264) || defined(CPU_MPC5746C) || defined(CPU_S32G274A) || defined(CPU_S32R45))

    #ifndef FREERTOS
    #error FREERTOS is required for Secure Socket Layer
    #endif /* FREERTOS */

    #ifndef NO_FILESYSTEM
    #error NO_FILESYSTEM is required for Secure Socket Layer
    #endif /* NO_FILESYSTEM */
    ...
    #define CSE_TIMEOUT 100
    #define HSM_TIMEOUT 100

#if (defined(CPU_MPC5748G) || defined(CPU_MPC5746C))
#if !ST_BENCH_WOLFSSL // disable HSM while benchmarking wolfSSL only -- by h1994st
    #define NXP_SDK_HSM  // -- by h1994st
	#define NXP_SDK_HSM_ALIGN 4  // 32 bits -- by h1994st
#endif /* !ST_BENCH_WOLFSSL */ // -- by h1994st
    #define NXP_SDK_PIT
    #define BIG_ENDIAN_ORDER
#endif /* defined(CPU_MPC5748G) || defined(CPU_MPC5746C) */

#if (defined(CPU_MPC5777C) || defined(CPU_S32V234) || defined(CPU_S32R274) || defined(CPU_S32R264))
    #define NXP_SDK_CSE
    #define NXP_SDK_PIT
    #define BIG_ENDIAN_ORDER
#endif /* defined(CPU_MPC5777C) || defined(CPU_S32V234) || defined(CPU_S32R274) || defined(CPU_S32R264) */

#if (defined(CPU_S32G274A) || defined(CPU_S32R45))
    #define NXP_SDK_HSE
    #define NXP_SDK_PIT
    #define LITTLE_ENDIAN_ORDER
#endif /* defined(CPU_S32G274A) || defined(CPU_S32R45) */

#if defined(CPU_S32K148)
    #define NXP_SDK_CSEC
    #define NXP_SDK_RTC_S32K
    #define LITTLE_ENDIAN_ORDER
#endif /* defined(CPU_S32K148) */
    ...
    // -- by h1994st: change the max size to 256
    #define AES_MAX_KEY_SIZE    256

#endif /*NXP_CPU_NAME*/
#endif /*NXP_SDK*/

#ifdef NXP_SDK_SJA1110x
    #ifndef FREERTOS
    #error FREERTOS is required for NXP_SDK_SJA1110x
    #endif /* FREERTOS */

    #ifndef NO_FILESYSTEM
    #error NO_FILESYSTEM is required for NXP_SDK_SJA1110x
    #endif /* NO_FILESYSTEM */
