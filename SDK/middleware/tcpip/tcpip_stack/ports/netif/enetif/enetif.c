 ...
 *
 * @section [global]
 * Violates MISRA 2012 Required Rule 4.10, Precautions shall be taken in order to
 * prevent the contents of file being included more than once.
 * lwip configuration file does not require guard header.
 *
 */
